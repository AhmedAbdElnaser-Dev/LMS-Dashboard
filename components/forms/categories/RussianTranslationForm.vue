...
// Determine edit mode based on Russian translation existence
const isEditMode = computed(() => {
  const ruTranslation = categoriesStore.selectedCategory?.translations?.ru
...
const handleSubmit = async () => {
  ...
  try {
    ...
    await categoriesStore.submitTranslation({
      language: 'ru', // Changed to Russian
